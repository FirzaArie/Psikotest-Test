...
//	}	
	...
	public void testPage() {
		...
		btnCognitif.click();
		test4.log(Status.PASS, "Tombol Cognitif berhasil");
		wait.until(ExpectedConditions.elementToBeClickable(btnBatalTest));
		btnBatalTest.click();
		test4.log(Status.PASS, "Tombol Batal Test Cognitif berhasil");
		wait.until(ExpectedConditions.elementToBeClickable(btnAccurate));
		btnAccurate.click();
		test4.log(Status.PASS, "Tombol Accurate berhasil");
		wait.until(ExpectedConditions.elementToBeClickable(btnBatalTest));
		btnBatalTest.click();
		test4.log(Status.PASS, "Tombol Batal Test Accurate berhasil");
		wait.until(ExpectedConditions.elementToBeClickable(btnProactive));
		btnProactive.click();
		test4.log(Status.PASS, "Tombol Cognitif berhasil");
		wait.until(ExpectedConditions.elementToBeClickable(btnBatalTest));
		btnBatalTest.click();
